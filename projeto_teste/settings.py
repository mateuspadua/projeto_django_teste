...
print SITE_ROOT
print "#########"
print normpath(join(DJANGO_ROOT, 'templates'))
print join(DJANGO_ROOT, 'templates')
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': 'projeto_teste',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 't_5kklbh#^h2zrc=&amp;l4lwm-6zlxh$m7z9sv30cu3_t0m@@l(s#'
